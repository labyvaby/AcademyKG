...
export const DoctorConclusionPanel: React.FC<DoctorConclusionPanelProps> = ({
    ...
    const loadData = useCallback(async (forceRefetch = false) => {
        ...
        try {
            ...
            // Load employee details for these performers
            ...
            const vWeight = aptData?.weight ? String(aptData.weight) : "";
            const vHeight = aptData?.height ? String(aptData.height) : "";
            const vTemp = aptData?.temperature ? String(aptData.temperature) : "";
