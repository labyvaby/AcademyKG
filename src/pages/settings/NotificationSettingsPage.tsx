                    ...
                    key === 'notification_created_interval' ? 'Интервал после создания (мин)' :
                        key === 'notification_reminder_interval' ? 'Интервал перед приемом (мин)' :
                            key === 'notification_created_10m_template' ? 'Шаблон уведомления после создания' :
                                'Шаблон напоминания перед приёмом'
            }));
                        ...
                        {history.length === 0 ? (
                            ...
                            history.map((item) => (
                                <TableRow key={item.id} hover>
                                    ...
                                    <TableCell>
                                        <Chip
                                            label={item.notification_type === 'created_10m' ? 'Подтверждение' : 'Напоминание'}
                                            size="small"
                                            color={item.notification_type === 'created_10m' ? 'primary' : 'secondary'}
                                            variant="outlined"
