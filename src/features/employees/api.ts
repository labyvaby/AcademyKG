...
export function mapAnyToEmployee(o: Record<string, unknown>): Employee | null {
  ...
  return { 
    id, 
    full_name, 
    phone: (typeof o.phone === 'string' ? o.phone : null) ?? (typeof o.phoneNumber === 'string' ? o.phoneNumber : null),
    role_id: typeof o.role_id === 'string' ? o.role_id : (typeof o.role === 'string' ? o.role : null),
